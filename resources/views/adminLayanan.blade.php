                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card border-0 ">
                                    <div class="card-body">
                                        <a href="/admin/layanan/create" class="btn btn-md btn-danger mb-3"> TAMBAH DATA</a> 
                                        <a href="/admin/layanan" class="btn btn-md btn-danger mb-3"><i class='fa fa-refresh'></i></a>
                                            ...
                                            @forelse ($layanans as $row)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="{{ route('layanan.show', $row->kode_layanan) }}" class="btn btn-sm btn-danger"> <i class='far fa-eye'></i> </a>
                                                        <a href="{{ route('layanan.edit', $row->kode_layanan) }}" class="btn btn-sm btn-danger"> <i class='fas fa-edit'> </i></a>
