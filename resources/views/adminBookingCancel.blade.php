                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr class="border-primary">
                                            <div class="form-group mb-3">
                                                <label class="font-weight-bold text-primary">CUSTOMER</label>
                                        ...
                                        <hr class="border-primary">
                                            <div class="form-group mb-3">
                                                <label class="font-weight-bold text-primary">HOTEL</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label class="font-weight-bold text-primary">KAMAR</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label class="font-weight-bold text-primary">HARGA KAMAR</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label class="font-weight-bold text-primary">LAYANAN</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label class="font-weight-bold text-primary">HARGA LAYANAN</label>
                                            ...
                                            <div class="form-group mb-3">
                                                <label class="font-weight-bold text-primary">Durasi Menginap</label>
                                        ...
                                        <hr class="border-primary">
                                            ...
                                            <div class="form-group mb-3">
                                                <label class="font-weight-bold text-primary">TOTAL TAGIHAN</label>
                                                <input type="text" class="form-control" name="total_tagihan" value="{{ $bookings->total_tagihan }}" readonly>
                                            </div>

                                            <div class="form-group mb-3">
                                                <label class="font-weight-bold text-primary">STATUS BOOKING</label>
                                                <input type="text" class="form-control" value="Menunggu Konfirmasi" readonly>
                                                <input type="hidden" class="form-control" name="status_bk" value="Dibatalkan" readonly>
                                            </div>

                                        <hr class="border-primary">

                                            <div class="modal-footer">
                                                <a href="/admin/layanan" class="btn btn-md btn-outline-primary me-4">BACK</a>

                                                <div class="btn-group">
                                                    <button type="submit" class="btn btn-md btn-danger">Cancel</button>
                                                </div>    
                                            </div>   
