                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card border-0 ">
                                    <div class="card-body">
                                        <a href="/admin/booking/create" class="btn btn-md btn-danger mb-3"> CREATE</a> 
                                        <a href="/admin/booking" class="btn btn-md btn-danger mb-3"><i class='fa fa-refresh'></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @if ($row->status_bk == 'Menunggu Konfirmasi')
                                                            <a href="{{ route('booking.show', $row->kode_bk) }}" class="btn btn-sm btn-danger"> <i class='far fa-eye'></i> </a>
                                                            <a href="{{ route('booking.confirm', $row->kode_bk) }}" class="btn btn-sm btn-danger"> <i class='far fa-check-circle'> </i></a>
